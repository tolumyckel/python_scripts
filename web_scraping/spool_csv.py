...
the_list = []
url_list = []
with open('Handles_CP.csv', 'r+') as csvfile:
                ...
                if type(output._json["url"]) is not types.NoneType:
                    ...
                    try:
                        ...
                        if response.ok:
                            ...
                            with open("twitter_handle2.json","w+") as jsonFile2:
                                json.dump(url_list, jsonFile2, indent=4)
                            print len(url_list), " handle information saved from google"
                            with open('twitter_handle2.csv', 'w+') as twitter_data2:
